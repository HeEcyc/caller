...
@SuppressWarnings("unused") public class CropImageView extends ImageView {
  ...
  private void drawHandles(Canvas canvas) {
    ...
    Drawable d = getResources().getDrawable(R.drawable.handle);
    drawDrawableHandle(d, (int)mFrameRect.left, (int)mFrameRect.top, canvas);
    drawDrawableHandle(d, (int)mFrameRect.right, (int)mFrameRect.top, canvas);
    drawDrawableHandle(d, (int)mFrameRect.left, (int)mFrameRect.bottom, canvas);
    drawDrawableHandle(d, (int)mFrameRect.right, (int)mFrameRect.bottom, canvas);
    d.draw(canvas);
...
//    canvas.drawCircle(mFrameRect.right, mFrameRect.bottom, mHandleSize, mPaintFrame);
  ...
  private void drawDrawableHandle(Drawable d, int centerX, int centerY, Canvas canvas) {
    d.setBounds(
      centerX - mHandleSize,
      centerY - mHandleSize,
      centerX + mHandleSize,
